...
### POSTMAN
1. Use POSTMAN to make REST calls and trigger the Boundary Message Events. The [POSTMAN Collection](Postman Collection for MessageEvents.postman_collection.json) can be used to get the REST calls.
